...
'Bad referrer'						=>	'HTTP_REFERER 错误。您从一个未经授权的地址接入本页。如果该问题再次发生，请检查设置 管理设置/配置选项 中的 \'根目录网址\' 填写是否正确，并确认您访问论坛的链接正是指向该网址。要获得关于此问题的更多信息请访问 FluxBB 官方论坛。',
'Bad csrf hash'						=>	'损坏的 CSRF 哈希值。你从一个未经授权的地址接入本页。',
...
'BBCode error tag not allowed'		=>	'您不具有使用 [%s] 标签的权限',
'BBCode error tag url not allowed'	=>	'您不具有发布链接的权限',
...
// Debug information
'Debug table'						=>	'Debug信息',
'Querytime'							=>	'耗时 %1$s 秒, 执行 %2$s 项查询请求',
