...
'Username too short'		=>	'用户名长度至少需要2字符。请重新选择(更长的)用户名。',
'Username too long'			=>	'用户名长度不可超过25字符。请重新选择(更短的)用户名。',
