...
'Board title'					=>	'论坛标题',
'Base URL'						=>	'您的 FluxBB 论坛网址(不含末尾斜杠) 。必须正确填写。',
...
'Info 1'						=>	'为了创建连接至您的数据库的所有信息。',
'Select database'				=>	'选择数据库类型',
'Info 2'						=>	'选择一个数据库。FluxBB 支持 MySQL， PostgreSQL 以及 SQLite。',
'Database type'					=>	'数据库类型',
'Required'						=>	'(必需)',
'Database hostname'				=>	'填写数据库服务器的主机名',
'Info 3'						=>	'如果不在这里使用<code>localhost</code>，您应该能够在您的主机上得到此处的详细信息。',
'Database server hostname'		=>	'数据库服务器主机名',
'Database enter name'			=>	'填写数据库名',
'Info 4'						=>	'安装 FluxBB 即将使用的数据库的名称。',
'Database name'					=>	'数据库名',
'Database enter informations'	=>	'填写您数据库的用户名及密码',
'Database username'				=>	'数据库用户名',
'Info 5'						=>	'您所要连接的MySQL数据库的用户名及密码(如使用 SQLite，此处请忽略)。',
'Database password'				=>	'数据库密码',
'Database enter prefix'			=>	'填写数据库表前缀',
'Info 6'						=>	'如果您准备在同一数据库中运行多个 FluxBB 副本，请更改此设置。',
'Table prefix'					=>	'数据表前缀',
'Administration setup'			=>	'管理员设置',
'Info 7'						=>	'创建该论坛的第一个账户。',
'Info 8'						=>	'用户名长度须在2至25字符之间。密码长度至少须6个字符。密码区分大小写。',
'Password'						=>	'密码',
'Confirm password'				=>	'确认密码',
'Board setup'					=>	'论坛设置',
'Info 11'						=>	'设置您的论坛。您可在稍后再作更改。',
'General information'			=>	'填写您的论坛的标题与描述。',
'Board description'				=>	'论坛描述 (支持 HTML)',
'Appearance'					=>	'外观',
'Info 15'						=>	'个性化您的论坛。为您的论坛设置默认语言与默认风格。',
'Default language'				=>	'默认语言',
'Default style'					=>	'默认风格',
'Start install'					=>	'开始安装',
'DB type not valid'				=>	'\'%s\' 不是一个有效的数据库类型',
'Table prefix error'			=>	'数据表前缀 \'%s\' 包含非法字符或过长。表前缀可包含字母 a 至 z，任何数字以及下划线。并且不能以数字开头。长度不超过40个字节。请另选表前缀',
