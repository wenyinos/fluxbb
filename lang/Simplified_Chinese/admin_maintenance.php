...
'Rebuild completed info'		=>	'一旦该过程结束，您将被重定向回此页面。如果重建过程被迫中止，您也可以记下已处理的最后一个帖子的ID然后将「起始帖子的ID」填写为该ID+1再继续建立索引(此时不得勾选「清空索引」选项)。',
'Rebuild index'					=>	'重建索引',
'Rebuilding search index'		=>	'重建搜索索引',
'Rebuilding index info'			=>	'正在重建索引。正是喝咖啡的好时机 :-)',
'Processing post'				=>	'正在处理帖子 <strong>%s</strong> …',
'Click here'					=>	'点击这里',
'Javascript redirect failed'	=>	'自动重定向不成功。 %s 继续 …',
